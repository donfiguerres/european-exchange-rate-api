...
public class ExchangeRateServiceTest {
    ...
    void testGetRatesForDate(String dateString, String currency, BigDecimal expected) {
    ...
    @Test
    void testGetRatesForDate_NotFound() {
        LocalDate date = LocalDate.of(2023, 6, 1);

        Exception exception = assertThrows(DataNotFoundException.class, () -> {
            exchangeRateService.getRatesForDate(date);
        });

        String expectedMessage = "Exchange rates for the date not found.";
    ...
    void testConvertCurrency(String dateString, String sourceCurrency,
            String targetCurrency, BigDecimal amount, BigDecimal expected) {
    ...
    @CsvSource({
            // target is missing
            "2023-05-30, BGN, EEK, 100",
            // source is missing
            "2023-05-30, EEK, BGN, 100",
            // both source and target are missing
            "2023-05-30, EEK, TRL, 100"
    })
    void testConvertCurrency_NotFound(String dateString, String sourceCurrency,
        ...
        String expectedMessage = "Exchange rates not found.";
        String actualMessage = exception.getMessage();
    ...
    @Test
    void testGetHighestRate_NotFound() {
        LocalDate startDate = LocalDate
                .parse("2023-05-24", DateTimeFormatter.ISO_DATE);
        LocalDate endDate = LocalDate
                .parse("2023-05-30", DateTimeFormatter.ISO_DATE);

        Exception exception = assertThrows(DataNotFoundException.class, () -> {
            exchangeRateService
                    .getHighestRate(startDate, endDate, "EEK");
        });
    ...
    @Test
    void testGetAverageRate_NotFound() {
        LocalDate startDate = LocalDate
                .parse("2023-05-24", DateTimeFormatter.ISO_DATE);
        LocalDate endDate = LocalDate
                .parse("2023-05-30", DateTimeFormatter.ISO_DATE);
        ...
        Exception exception = assertThrows(DataNotFoundException.class, () -> {
            exchangeRateService
                    .getAverageRate(startDate, endDate, "EEK");
        });
